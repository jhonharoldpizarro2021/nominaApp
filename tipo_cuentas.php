...
<script type="text/javascript" src="js/tipo_cuentas.js?n=<?= time() ?>"></script>
<div id="page-wrapper">
  <div class="row">
      <div class="col-lg-12">
          <h1 class="page-header"><i class="fa fa-barcode fa-fw"></i> Tipo de Cuentas</h1>
      </div>
      <!-- /.col-lg-12 -->
  </div>
  <!-- /.row -->
    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <button type="button" class="btn btn-default btn-circle btn-lg nuevaeps" data-toggle="modal" data-target="#modalNuevo"><i class="fa fa-plus"></i></button> Agregar Tipo de Cuenta
        </div>
        <!-- /.panel-heading -->
                ...
                if( $con )
                {
                  ...
                  ?>
                    <tr class="<?php echo $class ?> gradeX">
                      ...
                      <td class="center">
                        <a href="#" class="fa fa-pencil-square-o" aria-hidden="true" onclick="editar('<?= $row["id_tipo_cuenta"] ?>','<?= utf8_encode( $row["nombre"] ) ?>','<?= utf8_encode( $row["descripcion"] ) ?>')"></a>
                      </td>
                      <td class="center">
                        <a href="#" class="fa fa-trash-o" aria-hidden="true" onclick="eliminar('<?= $row["id_tipo_cuenta"] ?>','<?= utf8_encode( $row["nombre"] ) ?>')"></a>
                      </td>
                    </tr>
                <?php
                  }
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel"> <i class="fa fa-barcode fa-fw"></i> Tipo de Cuentas</h4>
        </div>
