...
<script type="text/javascript" src="js/nivel_estudio.js?n=<?= time() ?>"></script>
<div id="page-wrapper">
  <div class="row">
      <div class="col-lg-12">
          <h1 class="page-header"><i class="fa fa-graduation-cap fa-fw"></i> Niveles de Estudio</h1>
      </div>
      <!-- /.col-lg-12 -->
  </div>
  <!-- /.row -->
    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <button type="button" class="btn btn-default btn-circle btn-lg nuevaeps" data-toggle="modal" data-target="#modalNuevo"><i class="fa fa-plus"></i></button> Agregar Nivel de Estudio
        </div>
        <!-- /.panel-heading -->
          ...
          <div class="dataTable_wrapper table-responsive">
            <table class="table table-striped table-bordered table-hover " id="tabla">
              ...
              <?php
                ...
                if( $con )
                {
                  $query = "SELECT * FROM nivel_estudio ORDER BY nombre ASC";
                  ...
                  ?>
                    <tr class="<?php echo $class ?> gradeX">
                      ...
                      <td class="center">
                        <a href="#" class="fa fa-pencil-square-o" aria-hidden="true" onclick="editar('<?= $row["id_nivel_estudio"] ?>','<?= utf8_encode( $row["nombre"] ) ?>')"></a>
                      </td>
                      <td class="center">
                        <a href="#" class="fa fa-trash-o" aria-hidden="true" onclick="eliminar('<?= $row["id_nivel_estudio"] ?>','<?= utf8_encode( $row["nombre"] ) ?>')"></a>
                      </td>
                    </tr>
                <?php
                  }
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel"> <i class="fa fa-graduation-cap fa-fw"></i> Niveles de Estudio</h4>
        </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <form id="form_editar" role="form">
                        <input type="hidden" id="edit_id_nivel_estudio" name="edit_id_nivel_estudio">
                        <div class="row form-group">
