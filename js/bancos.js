  ...
  $.ajax(
  {
    ...
    success: function(res)
    {
      if( res.status === "OK" )
      {
        ...
        {
            var link_editar = '<a href="#" class="fa fa-pencil-square-o" aria-hidden="true" onclick="editar(\''+ res.bancos[i].id +'\',\''+ res.bancos[i].nombre +'\')"></a>';
            var link_borrar = '<a href="#" class="fa fa-trash-o" aria-hidden="true" onclick="eliminar(\''+ res.bancos[i].id +'\',\''+ res.bancos[i].nombre +'\')"></a>';
            datos[i] = [
                            res.bancos[i].nombre,
                            link_editar,
                            link_borrar
