...
<script type="text/javascript" src="js/departamento.js?n=<?= time() ?>"></script>
<div id="page-wrapper">
  <div class="row">
      <div class="col-lg-12">
          <h1 class="page-header"><i class="fa fa-map-signs fa-fw"></i> Departamentos</h1>
      </div>
      <!-- /.col-lg-12 -->
  </div>
  <!-- /.row -->
          ...
          <div class="dataTable_wrapper table-responsive">
            <table class="table table-striped table-bordered table-hover " id="tabla">
              ...
              <?php
                ...
                if( $con )
                {
                  $query = "SELECT * FROM qr_departamento_pais ORDER BY departamento ASC";
                  $resultado = mysqli_query($con, $query);
                  while( $row = mysqli_fetch_array($resultado) )
                  {
                  ?>
                    <tr class="<?php echo $class ?> gradeX">
                      <td><?= utf8_encode( $row["departamento"] ) ?></td>
                      <td><?= utf8_encode( $row["pais"] ) ?></td>
                      <td class="center">
                        <a href="#" class="fa fa-pencil-square-o" aria-hidden="true" onclick="editar('<?= $row["id_departamento"] ?>','<?= utf8_encode( $row["nombre_departamento"] ) ?>', '<?= $row["id_pais"] ?>')"></a>
                      </td>
                      <td class="center">
                        <a href="#" class="fa fa-trash-o" aria-hidden="true" onclick="eliminar('<?= $row["id_departamento"] ?>','<?= utf8_encode( $row["departamento"] ) ?>')"></a>
                      </td>
                    </tr>
                <?php
                  }
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel"> <i class="fa fa-map-signs fa-fw"></i> Departamentos</h4>
        </div>
                    ...
                    <div class="col-lg-12">
                      <form id="form_nuevo" role="form">
                        <div class="row form-group">
                          <label class="col-sm-3" for="new_departamento">Nombre:</label>
                          <div class="col-sm-9">
                            <input type="text" required id="new_departamento" name="new_departamento" class="form-control" placeholder="Nombre">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <form id="form_editar" role="form">
                        <input type="hidden" id="edit_id_departamento" name="edit_id_departamento">
                        <div class="row form-group">
