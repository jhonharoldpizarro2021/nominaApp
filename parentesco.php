...
<script type="text/javascript" src="js/parentesco.js?n=<?= time() ?>"></script>
<div id="page-wrapper">
  <div class="row">
      <div class="col-lg-12">
          <h1 class="page-header"><i class="fa fa-child fa-fw"></i> Parentescos</h1>
      </div>
      <!-- /.col-lg-12 -->
  </div>
  <!-- /.row -->
    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <button type="button" class="btn btn-default btn-circle btn-lg nuevaeps" data-toggle="modal" data-target="#modalNuevo"><i class="fa fa-plus"></i></button> Agregar Parentesco
        </div>
        <!-- /.panel-heading -->
                ...
                if( $con )
                {
                  ...
                  ?>
                    <tr class="<?php echo $class ?> gradeX">
                      ...
                      <td class="center">
                        <a href="#" class="fa fa-pencil-square-o" aria-hidden="true" onclick="editar('<?= $row["id_parentesco"] ?>','<?= utf8_encode( $row["nombre"] ) ?>','<?= utf8_encode( $row["descripcion"] ) ?>')"></a>
                      </td>
                      <td class="center">
                        <a href="#" class="fa fa-trash-o" aria-hidden="true" onclick="eliminar('<?= $row["id_parentesco"] ?>','<?= utf8_encode( $row["nombre"] ) ?>')"></a>
                      </td>
                    </tr>
                <?php
                  }
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel"> <i class="fa fa-child fa-fw"></i> Parentescos</h4>
        </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <form id="form_nuevo" role="form">
                        ...
                        <div class="row form-group">
                          <label class="col-sm-3" for="new_descripcion">Descripci&oacute;n:</label>
                          <div class="col-sm-9">
                            <input type="text" required id="new_descripcion" name="new_descripcion" class="form-control" placeholder="Descripcion">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <form id="form_editar" role="form">
                        <input type="hidden" id="edit_id_parentesco" name="edit_id_parentesco">
                        <div class="row form-group">
                        ...
                        <div class="row form-group">
                          <label class="col-sm-3" for="edit_descripcion">Descripci&oacute;n:</label>
                          <div class="col-sm-9">
                            <input type="text" id="edit_descripcion" name="edit_descripcion" class="form-control" placeholder="Nombres">
                            <div id="msg_error_nombre" class="alert alert-danger" role="alert">Campo requerido</div>
                          </div>
                        </div>
                        <div class="row form-group text-center">
